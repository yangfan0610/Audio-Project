...
def max_pool_new2(x):
    return tf.nn.max_pool(x, ksize=[1, 1, 10, 1],strides=[1, 1, 10, 1], padding='SAME')
...
h_pool1 = max_pool_new1(h_conv1)

#resnet block
w_conv2_1 = weight_variable([1, 10, 16, 16])
b_conv2_1 = bias_variable([16])
h_conv2_1 = tf.nn.relu(conv2d(h_pool1, w_conv2_1) + b_conv2_1)

w_conv2_2 = weight_variable([1, 10, 16, 16])
b_conv2_2 = bias_variable([16])
h_conv2_2 = conv2d(h_conv2_1, w_conv2_2) + b_conv2_2

h_conv2 = tf.nn.relu(tf.add(h_pool1,h_conv2_2))
h_pool2 = max_pool_new2(h_conv2)
